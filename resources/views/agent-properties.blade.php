        ...
        <div class="row">
          <div class="col-md-3">
              ...
              <div class="user-thumb">
                <img src="{{$agent->photo ? asset($agent->photo) : asset('images/dashboard/user/demo-user.png')}}" class="img-responsive" alt="" style="width: 100%; height:100%; object-fit:cover">
                <div class="varified">
          ...
          <div class="col-md-9 margin-balance">
