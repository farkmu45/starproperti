                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input id="name" type="text" class="form-control" placeholder="Nama Lengkap" required name="name">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input id="phone_number" type="text" class="form-control" placeholder="Nomor HP" required name="phone_number">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input id="password" type="password" class="form-control" placeholder="Kata Sandi" required name="password">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input id="password" type="password" class="form-control" placeholder="Konfirmasi Kata Sandi" required name="password_confirmation">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <button type="submit" class="button primary-bg">Daftar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
